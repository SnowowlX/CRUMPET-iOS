...
class FlutterTailMovesVC: UIViewController{
    ...
    func checkCasualModeIsOn() {
        if AppDelegate_.casualONFlutter || AppDelegate_.walkModeOn || AppDelegate_.moveOn {
            // already started
    ...
    func setupLocalization()  {
        self.title = NSLocalizedString("kTail Flutter Moves", comment: "")
